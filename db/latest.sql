--------------------------------------------------------
--  File created - Saturday-January-21-2023   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table BOOK
--------------------------------------------------------
...
Insert into PROJECT502.BOOK (BOOKID,BOOK_NAME,BOOK_AUTHOR,BOOK_PRICE,ISBN,SUPPLIER_ID,PUBLICATION_DATE,IMAGE_URL) values (1,'Book 1','Author 1',10,'1234567890123',3,to_date('06/01/2022','DD/MM/RRRR'),'assets/img/product/Jujutsu_kaisen.png');
...
Insert into PROJECT502.STAFF (STAFFID,FIRST_NAME,LAST_NAME,PHONE_NUMBER,SALARY,HIRE_DATE,PASSWORD,POSITION,SUPERVISOR_ID,EMAIL,ADDRESS) values (2,'Albert','Doe','1234567895',100000,to_date('01/01/2021','DD/MM/RRRR'),'$2y$10$.42TjOUYjdGDtJDXpxFJuOsP./yaRa3xG1xa5dU26waOL0.JEgqyu','Staff',1,'123@email.com','123');
REM INSERTING into PROJECT502.SUPPLIER
SET DEFINE OFF;
Insert into PROJECT502.SUPPLIER (SUPPLIER_ID,SUPPLIER_NAME,SUPPLIER_ADDRESS,CONTACT_PERSON,PHONE_NUMBER) values (1,'Supplier 1A','123 Elm St','John Doe','+1 123 456 7890');
