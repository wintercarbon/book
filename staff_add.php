...
if (isset($_POST['add'])) {
    ...
    $result = $staff->insertStaff($first_name, $last_name, $phone_number, $salary, $hire_date, $password, $position, $supervisor_id, $email, $address);
    if ($result) {
        $newstaff =  $staff->getStaffIdSeq();
        echo "'<script>alert('Staff added successfully')</script>";
        echo '<script>window.location.href = "staff_detail.php?staffid='. $newstaff . '"</script>';
    }
    else {
...
<input type="number" name="supervisor_id" value="">
</div>
</div>
...
<div class="col-lg-12">
<input type="submit" name="add" value="add" class="btn btn-submit me-2">Submit</input>
